...
function activateAddAnnotationMode() {
  ...
  if (adminAddNoteBtn) {
    adminAddNoteBtn.innerHTML = '<span class="emoji-icon" style="display: flex; align-items: center; justify-content: center; width: 26px; height: 26px;"><svg id="text-box-custom-icon" width="26" height="26" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.3" stroke-linecap="round" stroke-linejoin="round" style="color: #ef4444; width: 26px; height: 26px; fill: none !important;"><path d="M5 3h14v13h-3a2 2 0 0 0-2 2v3H5V3z" style="fill: none !important;"></path><path d="M14 21c0-1.5 1.5-3 3-3h2" style="fill: none !important;"></path><path d="M8 7h8M8 10h8M8 13h8" style="fill: none !important;"></path></svg></span>';
...
function deactivateAddAnnotationMode() {
  ...
  if (adminAddNoteBtn) {
    adminAddNoteBtn.innerHTML = '<span class="emoji-icon" style="display: flex; align-items: center; justify-content: center; width: 26px; height: 26px;"><svg id="text-box-custom-icon" width="26" height="26" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.3" stroke-linecap="round" stroke-linejoin="round" style="color: #64748b; width: 26px; height: 26px; fill: none !important;"><path d="M5 3h14v13h-3a2 2 0 0 0-2 2v3H5V3z" style="fill: none !important;"></path><path d="M14 21c0-1.5 1.5-3 3-3h2" style="fill: none !important;"></path><path d="M8 7h8M8 10h8M8 13h8" style="fill: none !important;"></path></svg></span>';
...
function activateAddPersonMode() {
  ...
  adminAddBtn.innerHTML = '<span class="emoji-icon" style="display: flex; align-items: center; justify-content: center; width: 26px; height: 26px;"><svg class="custom-add-person-icon" width="26" height="26" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.3" stroke-linecap="round" stroke-linejoin="round" style="color: #ef4444; width: 26px; height: 26px; fill: none !important;"><circle cx="10" cy="8" r="4" style="fill: none !important;"></circle><path d="M3 20a7 7 0 0 1 14 0" style="fill: none !important;"></path><path d="M17 9h6" style="fill: none !important;"></path></svg></span>';
...
function deactivateAddPersonMode() {
  ...
  adminAddBtn.innerHTML = '<span class="emoji-icon" style="display: flex; align-items: center; justify-content: center; width: 26px; height: 26px;"><svg class="custom-add-person-icon" width="26" height="26" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.3" stroke-linecap="round" stroke-linejoin="round" style="color: #64748b; width: 26px; height: 26px; fill: none !important;"><circle cx="10" cy="8" r="4" style="fill: none !important;"></circle><path d="M3 20a7 7 0 0 1 14 0" style="fill: none !important;"></path><path d="M17 9h6M20 6v6" style="fill: none !important;"></path></svg></span>';
...
function deactivateAddPolygonMode() {
  ...
  if (btn) {
    ...
    btn.innerHTML = '<span class="emoji-icon" style="display: flex; align-items: center; justify-content: center; width: 26px; height: 26px;"><svg class="custom-add-polygon-icon" width="26" height="26" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.3" stroke-linecap="round" stroke-linejoin="round" style="color: #64748b; width: 26px; height: 26px; fill: none !important;"><rect x="4" y="4" width="16" height="16" rx="3" style="fill: none !important;"></rect><path d="M8 4v16M12 4v16M16 4v16M4 8h16M4 12h16M4 16h16" style="fill: none !important;"></path></svg></span>';
  }
}
...
function activateAddPolygonMode() {
  ...
  if (btn) {
    ...
    btn.innerHTML = '<span class="emoji-icon" style="display: flex; align-items: center; justify-content: center; width: 26px; height: 26px;"><svg class="custom-add-polygon-icon" width="26" height="26" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.3" stroke-linecap="round" stroke-linejoin="round" style="color: #ef4444; width: 26px; height: 26px; fill: none !important;"><rect x="4" y="4" width="16" height="16" rx="3" style="fill: none !important;"></rect><path d="M8 4v16M12 4v16M16 4v16M4 8h16M4 12h16M4 16h16" style="fill: none !important;"></path></svg></span>';
  }
