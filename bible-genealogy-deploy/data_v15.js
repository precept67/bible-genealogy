...
const BIBLE_CHARACTERS = [
  ...
  { id: "hezron", name: "헤스론", engName: "Hezron", gender: "M", generation: 24, column: 0, parents: ["perez"], spouses: ["machir_daughter", "azubah_caleb", "jerioth", "ephrath", "ephah_concubine", "maachah_concubine", "unknown_wife_caleb"], desc: "베레스의 아들.", isMain: true },
  
  // Hezron's marriage to Machir's daughter (1 Chr 2:21-22)
  { id: "machir_daughter", name: "마길의 딸", engName: "Daughter of Machir", gender: "F", generation: 24, column: -0.8, parents: [], spouses: ["hezron"], desc: "길레앗의 아버지 마길의 딸.", isMain: false },
  { id: "segub_hezron", name: "스굽", engName: "Segub", gender: "M", generation: 25, column: -0.8, parents: ["hezron", "machir_daughter"], spouses: [], desc: "헤스론과 마길의 딸의 아들.", isMain: false },
  { id: "jair_segub", name: "야일", engName: "Jair", gender: "M", generation: 26, column: -0.8, parents: ["segub_hezron"], spouses: [], desc: "스굽의 아들. 길레앗 땅에서 스물세 성읍을 가졌던 자.", isMain: false },
  ...
  { id: "zadok_priest1", name: "사독", engName: "Zadok", gender: "M", generation: 35, column: 3.6, parents: ["ahitub_priest1"], spouses: [], desc: "다윗 and 솔로몬 시대의 충성스러운 대제사장. 사독 계열의 시조.", isMain: false },
  { id: "ahimaaz_priest", name: "아히마아스", engName: "Ahimaaz", gender: "M", generation: 36, column: 3.6, parents: ["zadok_priest1"], spouses: [], desc: "사독의 아들. 다윗의 전령.", isMain: false },
  { id: "azariah_priest1", name: "아사랴", engName: "Azariah", gender: "M", generation: 37, column: 3.6, parents: ["ahimaaz_priest"], spouses: [], desc: "솔로몬 성전의 대제사장.", isMain: false },
  { id: "johanan_priest", name: "요하난", engName: "Johanan", gender: "M", generation: 38, column: 3.6, parents: ["azariah_priest1"], spouses: [], desc: "대제사장.", isMain: false },
  { id: "azariah_priest2", name: "아사랴(중기)", engName: "Azariah", gender: "M", generation: 39, column: 3.6, parents: ["johanan_priest"], spouses: [], desc: "솔로몬 성전에서 제사장 직분을 행한 자.", isMain: false },
  { id: "amariah_priest2", name: "아마랴(중기)", engName: "Amariah", gender: "M", generation: 40, column: 3.6, parents: ["azariah_priest2"], spouses: [], desc: "대제사장.", isMain: false },
  { id: "ahitub_priest2", name: "아히둡(중기)", engName: "Ahitub", gender: "M", generation: 41, column: 3.6, parents: ["amariah_priest2"], spouses: [], desc: "대제사장.", isMain: false },
  { id: "zadok_priest2", name: "사독(중기)", engName: "Zadok", gender: "M", generation: 42, column: 3.6, parents: ["ahitub_priest2"], spouses: [], desc: "대제사장.", isMain: false },
  { id: "shallum_priest", name: "살룸", engName: "Shallum", gender: "M", generation: 43, column: 3.6, parents: ["zadok_priest2"], spouses: [], desc: "대제사장 (살룸/므슐람).", isMain: false },
  { id: "hilkiah_priest", name: "힐기야", engName: "Hilkiah", gender: "M", generation: 44, column: 3.6, parents: ["shallum_priest"], spouses: [], desc: "요시야 왕 시절 성전 정화 중 율법책을 발견한 대제사장.", isMain: false },
  { id: "azariah_priest3", name: "아사랴(말기)", engName: "Azariah", gender: "M", generation: 45, column: 3.6, parents: ["hilkiah_priest"], spouses: [], desc: "대제사장.", isMain: false },
  { id: "seraiah_priest", name: "스라야", engName: "Seraiah", gender: "M", generation: 46, column: 3.6, parents: ["azariah_priest3"], spouses: [], desc: "예루살렘 함락 시 느부갓네살에 의해 죽임 당한 마지막 대제사장.", isMain: false },
  { id: "jehozadak_priest", name: "여호사닥", engName: "Jehozadak", gender: "M", generation: 47, column: 3.6, parents: ["seraiah_priest"], spouses: [], desc: "바벨론 포로로 잡혀간 대제사장. 학개의 동역자 여호수아의 아버지.", isMain: false },
  ...
  { id: "taphath", name: "다밧", engName: "Taphath", gender: "F", generation: 34, column: -1.5, parents: ["solomon"], spouses: [], desc: "솔로몬 왕의 딸. 아비나답의 아들(벤아비나답)의 아내가 됨(왕상 4:11).", isMain: false },
  { id: "basemath", name: "바스맛", engName: "Basemath", gender: "F", generation: 34, column: -3.0, parents: ["solomon"], spouses: [], desc: "솔로몬 왕의 딸. 아히마아스의 아내가 됨(왕상 4:15).", isMain: false },
