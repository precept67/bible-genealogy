...
(function() {
  ...
  if (!window.localStorage.getItem('bible_tree_line_bends')) {
  ...
  if (!window.localStorage.getItem('bible_tree_spouse_splits')) {
  ...
  if (!window.localStorage.getItem('bible_tree_style_settings')) {
  ...
  const curAnnots = window.localStorage.getItem('bible_tree_annotations');
  let annotCount = 0;
  try { annotCount = curAnnots ? JSON.parse(curAnnots).length : 0; } catch(e) {}
  if (!curAnnots || curAnnots === '[]' || annotCount < 10 || !window.localStorage.getItem(seedKey)) {
