...
/// === AUTO-INJECTED SEED DATA FOR LINES AND ANNOTATIONS (NON-DESTRUCTIVE SAFE MERGE) ===
(function() {
  const seedKey = 'bible_tree_full_data_v16_v8';
  
  // Safe merge helper: keeps existing items by ID, appends missing default seeds
  function safeSeedArray(storageKey, defaultItems) {
  ...
  function safeSeedObject(storageKey, defaultObj) {
    const raw = window.localStorage.getItem(storageKey);
    if (!raw || raw === '{}') {
      window.localStorage.setItem(storageKey, JSON.stringify(defaultObj));
      return;
    }
    try {
      const existing = JSON.parse(raw);
  ...
  safeSeedObject('bible_tree_line_bends', {"bathsheba+david": [{"x": 15543.880000000001, "y": 5970}], "rel-adam+eve": [{"x": 16443.88, "y": 210}], "rel-jokshan": [{"x": 25123.88, "y": 3810}], "rel-terah": [{"x": 18493.88, "y": 3440}, {"x": 18593.88, "y": 3140}], "rel-abraham+keturah": [{"x": 14053.880000000001, "y": 3630}, {"x": 13543.880000000001, "y": 3630}], "rel-abraham+hagar": [{"x": 17913.88, "y": 3560}], "rel-terah->nahor": [{"x": 16593.88, "y": 3450}, {"x": 16343.880000000001, "y": 2770}], "rel-terah->haran": [{"x": 15533.880000000001, "y": 3450}, {"x": 15423.880000000001, "y": 2950}], "rel-bathsheba+david->nathan_bathsheba": [{"x": 18373.88, "y": 5970}], "spouse-abraham+keturah": [{"x": 14643.880000000001, "y": 2930}, {"x": 14643.880000000001, "y": 3540}], "rel-isaac+rebekah->esau": [{"x": 12893.880000000001, "y": 3810}, {"x": 12823.880000000001, "y": 3430}], "rel-hezron+machir_daughter->segub_hezron": [{"x": 18683.88, "y": 4510}], "rel-sheshan_ishi->ahlai_sheshan": [{"x": 15673.880000000001, "y": 5760}, {"x": 15382.395625000001, "y": 5791.5}], "rel-abraham+hagar->ishmael": [{"x": 14310, "y": 3560}]});

  if (!window.localStorage.getItem('bible_tree_custom_visual_lines')) {
    window.localStorage.setItem('bible_tree_custom_visual_lines', JSON.stringify([]));
  }
  if (!window.localStorage.getItem('bible_tree_canvas_junctions')) {
    window.localStorage.setItem('bible_tree_canvas_junctions', JSON.stringify([]));
  }

  safeSeedObject('bible_tree_spouse_splits', {"adam+eve": 0.5660661764705925, "gilead_conc+gilead_man": 0.0631371572066321, "jacob+zilpah": 0.8562547987422477, "bilhah+jacob": 0.95516, "jacob+rachel": 0.8936402261568482, "abraham+keturah": 0.018, "abraham+hagar": 0.02, "basemath_esau+esau": 0.7556966021160495, "esau+oholibamah": 0.9262121127118996, "ahinoam_david+david": 0.8711067813637272, "abigail_david+david": 0.9385042519485669, "david+maachah_david": 0.95, "david+other_wives_david": 0.95, "david+eglah_david": 0.95, "abital_david+david": 0.95, "david+haggith_david": 0.95, "abiah_hezron+hezron": 0.27929022873194187, "chelubai+unknown_wife_caleb": 0.95, "chelubai+maachah_concubine": 0.9443092186906878, "chelubai+ephrath": 0.8366929567131333, "chelubai+ephah_concubine": 0.8991033380681825, "adah_cain+lamech_cain": 0.38115625000000364, "lamech_cain+zillah_cain": 0.6499062500000037});

  safeSeedObject('bible_tree_style_settings', {"lineColor": "#919191", "mainLineColor": "#ff9300", "spouseLineColor": "#ef4444", "lineWidth": 3, "cornerRadius": 12, "splitOffset": 90, "lineType": "orthogonal", "siblingGap": 7});

  // Seed Annotations (Text Boxes)
  safeSeedArray('bible_tree_annotations', [{"id": "note-welcome", "text": "성경 인물 족보 보드\n(마우스 드래그로 이동, 휠로 확대/축소)", "x": 167.1999999999989, "y": 40, "width": 260, "height": 55, "fontSize": 13, "bold": true, "color": "#1e293b", "bgColor": "#f8fafc"}, {"id": "note-1784793168468", "text": "마태복음족보의 첫번째 14대", "x": 16023.517429320618, "y": 3432.2035590517808, "width": 253, "height": 64, "fontSize": 20, "bold": false, "color": "#ffffff", "bgColor": "#6baef5", "borderWidth": 1, "align": "center", "borderStyle": "dashed", "relatedPeople": ["nahshon", "ram", "perez", "boaz", "salmon", "abraham", "amminadab", "jacob", "obed", "judah", "isaac", "jesse", "david", "hezron"], "relatedEvents": [], "relatedLocations": []}, {"id": "note-1784796431452", "text": "마태복음 족보의  두번째 14대", "x": 15960.757880757512, "y": 5710.19782375844, "width": 266, "height": 69, "fontSize": 20, "bold": false, "color": "#ffffff", "bgColor": "#70a7ff", "relatedPeople": ["david", "rehoboam", "solomon", "abijah", "asa", "jehoram", "jehoshaphat", "manasseh_king", "amon", "ahaz", "jotham", "josiah", "uzziah", "hezekiah"], "relatedEvents": [], "relatedLocations": []}, {"id": "note-1784797119640", "text": "마태복음 족보의 세번째 14대", "x": 15898.093986335522, "y": 9079.803071376915, "width": 269, "height": 63, "fontSize": 20, "bold": false, "color": "#f7f7f8", "bgColor": "#70aaf5", "relatedPeople": ["matthan", "zadok_gen56", "zerubbabel", "shealtiel", "abiud", "azor", "achim", "jacob_joseph", "eleazar", "eliakim", "eliud", "jeconiah", "jesus", "joseph_mary"], "relatedEvents": [], "relatedLocations": []}, {"id": "note-reuben-chiefs-title", "text": "다른 시대 우두머리된 자", "x": 6513.342857142856, "y": 5429.142857142857, "width": 240, "height": 36, "fontSize": 20, "bold": true, "italic": false, "underline": false, "align": "center", "color": "#5c2407", "bgColor": "transparent", "borderStyle": "none", "borderWidth": 0, "borderColor": "", "relatedPeople": ["bela_reuben", "zechariah_reuben", "jeiel_reuben"], "relatedEvents": [], "relatedLocations": []}, {"id": "note-1785291855597", "text": "동일인", "x": 13816.598659087793, "y": 3595.122973775984, "width": 96, "height": 35, "fontSize": 12, "bold": false, "color": "#1e293b", "bgColor": "#8bfb5b", "relatedPeople": ["mahalath", "Mahalath-wife"], "relatedEvents": [], "relatedLocations": [], "borderStyle": "none"}, {"id": "note-1785292430353", "text": "1대 사사 , 40년 (삿 3:9,11)\n", "x": 20238, "y": 5619, "width": 158, "height": 75, "fontSize": 20, "bold": false, "color": "#1e293b", "bgColor": "#51f56d", "borderStyle": "none", "relatedPeople": ["othniel_kenaz"], "relatedEvents": [], "relatedLocations": []}, {"id": "annotation_1785292757614_wb806c401", "text": "8대 사사 , 6년 (삿 11:1)\n", "x": 25499, "y": 4910, "width": 158, "height": 75, "fontSize": 20, "bold": false, "italic": false, "underline": false, "align": "center", "borderStyle": "none", "borderWidth": 1, "color": "#1e293b", "bgColor": "#51f56d", "borderColor": "#cbd5e1", "auraEnabled": true, "relatedPeople": ["jephthah_man"], "relatedEvents": [], "relatedLocations": []}, {"id": "annotation_1785292925306_m9cbn9bjr", "text": "7대 사사 , 22년 (삿 10:3)\n", "x": 25595, "y": 5122, "width": 158, "height": 75, "fontSize": 20, "bold": false, "italic": false, "underline": false, "align": "center", "borderStyle": "none", "borderWidth": 1, "color": "#1e293b", "bgColor": "#51f56d", "borderColor": "#cbd5e1", "auraEnabled": true, "relatedPeople": ["jair_man"], "relatedEvents": [], "relatedLocations": []}, {"id": "annotation_1785293023070_efeopqim2", "text": "5대 사사 , 40년 (삿 6:11)\n", "x": 26901, "y": 4867, "width": 158, "height": 75, "fontSize": 20, "bold": false, "italic": false, "underline": false, "align": "center", "borderStyle": "none", "borderWidth": 1, "color": "#1e293b", "bgColor": "#51f56d", "borderColor": "#cbd5e1", "auraEnabled": true, "relatedPeople": ["gideon_man"], "relatedEvents": [], "relatedLocations": []}, {"id": "annotation_1785293079620_9c9enhss1", "text": "4대 사사 , 40년 \n(삿 4:4)\n", "x": 28302.666666666664, "y": 5092.666666666667, "width": 166, "height": 75, "fontSize": 20, "bold": false, "italic": false, "underline": false, "align": "center", "borderStyle": "none", "borderWidth": 1, "color": "#1e293b", "bgColor": "#51f56d", "borderColor": "#cbd5e1", "auraEnabled": true, "relatedPeople": ["deborah_eph"], "relatedEvents": [], "relatedLocations": []}, {"id": "annotation_1785293244284_imihnm12l", "text": "11대 사사 , 8년 \n(삿 12:15)\n", "x": 28295.999999999996, "y": 5364.333333333334, "width": 166, "height": 75, "fontSize": 20, "bold": false, "italic": false, "underline": false, "align": "center", "borderStyle": "none", "borderWidth": 1, "color": "#1e293b", "bgColor": "#51f56d", "borderColor": "#cbd5e1", "auraEnabled": true, "relatedPeople": ["abdon_eph"], "relatedEvents": [], "relatedLocations": []}, {"id": "annotation_1785294497423_odljtntro", "text": "6대 사사 , 23년 (삿 6:1-2)\n", "x": 21353, "y": 4873.166666666666, "width": 158, "height": 75, "fontSize": 20, "bold": false, "italic": false, "underline": false, "align": "center", "borderStyle": "none", "borderWidth": 1, "color": "#1e293b", "bgColor": "#51f56d", "borderColor": "#cbd5e1", "auraEnabled": true, "relatedPeople": ["tola-judges"], "relatedEvents": [], "relatedLocations": []}, {"id": "annotation_1785294547788_pdgzw7hbp", "text": "9대 사사, 23년 (삿 12:8-10)\n", "x": 22089.666666666668, "y": 4879.4047619047615, "width": 158, "height": 75, "fontSize": 20, "bold": false, "italic": false, "underline": false, "align": "center", "borderStyle": "none", "borderWidth": 1, "color": "#1e293b", "bgColor": "#51f56d", "borderColor": "#cbd5e1", "auraEnabled": true, "relatedPeople": ["Ibzan"], "relatedEvents": [], "relatedLocations": []}, {"id": "annotation_1785294631445_331zs2q25", "text": "10대 사사 , 10년 (삿 12:11)\n", "x": 21944.666666666668, "y": 4352.333333333333, "width": 166, "height": 73, "fontSize": 20, "bold": false, "italic": false, "underline": false, "align": "center", "borderStyle": "none", "borderWidth": 1, "color": "#1e293b", "bgColor": "#51f56d", "borderColor": "#cbd5e1", "auraEnabled": true, "relatedPeople": ["elon_zebulun"], "relatedEvents": [], "relatedLocations": []}, {"id": "annotation_1785294842193_ncx8hriqj", "text": "12대 사사 , 20년 \n(삿 13-16장)\n", "x": 34974.73322403357, "y": 4725.439083856107, "width": 166, "height": 75, "fontSize": 20, "bold": false, "italic": false, "underline": false, "align": "center", "borderStyle": "none", "borderWidth": 1, "color": "#1e293b", "bgColor": "#51f56d", "borderColor": "#cbd5e1", "auraEnabled": true, "relatedPeople": ["samson-dan"], "relatedEvents": [], "relatedLocations": []}, {"id": "annotation_1785295065099_tsuzbkhq1", "text": "2대 사사 , 80년 \n(삿 3:13-30)\n", "x": 32138.666666666664, "y": 6031.809523809524, "width": 166, "height": 75, "fontSize": 20, "bold": false, "italic": false, "underline": false, "align": "center", "borderStyle": "none", "borderWidth": 1, "color": "#1e293b", "bgColor": "#51f56d", "borderColor": "#cbd5e1", "auraEnabled": true, "relatedPeople": ["ehud"], "relatedEvents": [], "relatedLocations": []}, {"id": "annotation_1785295229326_ba5jm30ex", "text": "3대 사사  \n(삿 3:31)\n", "x": 34382.666666666664, "y": 4578.809523809524, "width": 166, "height": 75, "fontSize": 20, "bold": false, "italic": false, "underline": false, "align": "center", "borderStyle": "none", "borderWidth": 1, "color": "#1e293b", "bgColor": "#51f56d", "borderColor": "#cbd5e1", "auraEnabled": true, "relatedPeople": ["shamgar"], "relatedEvents": [], "relatedLocations": []}, {"id": "annotation_1785464733167_cos0kd8cc", "text": "동명이인", "x": 16201, "y": 1601, "width": 96, "height": 38, "fontSize": 12, "bold": false, "italic": false, "underline": false, "align": "center", "borderStyle": "dashed", "borderWidth": 1, "color": "#1e293b", "bgColor": "#c3adf5", "borderColor": "#cbd5e1", "auraEnabled": true, "relatedPeople": ["lamech", "lamech_cain"], "relatedEvents": [], "relatedLocations": []}, {"id": "annotation_1785465647957_2j351uc9h", "text": "북이스라엘의 왕들", "x": 15052.029501909059, "y": 5980.328507915665, "width": 258, "height": 36, "fontSize": 20, "bold": false, "italic": false, "underline": false, "align": "center", "borderStyle": "dashed", "borderWidth": 1, "color": "#ffffff", "bgColor": "#8e44fd", "borderColor": "#cbd5e1", "auraEnabled": true, "relatedPeople": ["nadab_jeroboam", "nebat", "baasha", "zeruah_nebat", "abijah_jeroboam", "elah_baasha", "jeroboam1", "jeroboam2"], "relatedEvents": [], "relatedLocations": []}, {"id": "annotation_1785470291928_ecqjxrpbl", "text": "가문의 지도자들\n(대상 4:34-38)", "x": 7558.342857142856, "y": 4478.142857142857, "width": 167, "height": 71, "fontSize": 20, "bold": true, "italic": false, "underline": false, "align": "center", "borderStyle": "none", "borderWidth": 1, "color": "#5c2407", "bgColor": "transparent", "borderColor": "#cbd5e1", "auraEnabled": true}, {"id": "annotation_1786037834044_s9u87t0re", "text": "동명이인", "x": 16200, "y": 1244, "width": 96, "height": 38, "fontSize": 12, "bold": false, "italic": false, "underline": false, "align": "center", "borderStyle": "dashed", "borderWidth": 1, "color": "#1e293b", "bgColor": "#c3adf5", "borderColor": "#cbd5e1", "auraEnabled": true, "relatedPeople": ["enoch_cain", "enoch"], "relatedEvents": [], "relatedLocations": []}, {"id": "annotation_1786089563807_13lwr6672", "text": "동일인", "x": 16642.817863922064, "y": 3768.9061356719512, "width": 96, "height": 38, "fontSize": 12, "bold": false, "italic": false, "underline": false, "align": "center", "borderStyle": "dashed", "borderWidth": 1, "color": "#1e293b", "bgColor": "#abf75f", "borderColor": "#cbd5e1", "auraEnabled": true, "relatedPeople": ["rebekah", "rebekah_daughter"], "relatedEvents": [], "relatedLocations": []}, {"id": "annotation_1786089693693_m9wwg8a49", "text": "동일인", "x": 17215.668684546603, "y": 3422.555838977626, "width": 96, "height": 38, "fontSize": 12, "bold": false, "italic": false, "underline": false, "align": "center", "borderStyle": "dashed", "borderWidth": 1, "color": "#1e293b", "bgColor": "#abf75f", "borderColor": "#cbd5e1", "auraEnabled": true, "relatedPeople": ["milcah", "milcah_daughter"], "relatedEvents": [], "relatedLocations": []}]);

  // Seed Events
  safeSeedArray('bible_tree_events', [{"id": "ev-1784788761811", "name": "가인의 아벨 살인 사건", "desc": "하나님께서 아벨의 제사만 받으시자 이에 분노한 형 가인이 들판에서 아우 아벨을 돌로 쳐 죽인 인류 최초의 살인 사건.", "refs": ["창세기 4:8"], "relatedLocations": ["loc-east_eden"], "relatedPeople": ["cain", "abel"], "x": 15791, "y": 251, "engName": "Cain's murder of Abel", "engDesc": "When God only accepted Abel's sacrifice, the older brother Cain became angry and stoned his younger brother Abel to death in the field, the first murder case in history."}, {"id": "ev-1784789196127", "name": "노아의 방주와 대홍수 심판", "desc": "온 세상의 해악이 가득 참에 분노하신 하나님께서 40일 동안 비를 내려 전 지구를 홍수로 심판하시고 노아의 여덟 식구만 구원하신 사건.", "refs": ["창세기 7:11", "창세기 7:23"], "relatedLocations": ["loc-ararat"], "relatedPeople": ["noah", "shem", "japheth", "ham", "noah_wife", "shem_wife", "japheth_wife", "ham_wife"], "x": 16188, "y": 1791, "engName": "Noah's Ark and the Flood Judgment", "engDesc": "An incident in which God, angry at the world being filled with evil, made it rain for 40 days, judged the entire earth with a flood, and saved only Noah's family of eight."}, {"id": "ev-1784791438912", "name": "천지창조", "desc": "", "refs": [], "relatedLocations": [], "relatedPeople": [], "x": 16127, "y": 4, "engName": "creation of heaven and earth"}, {"id": "ev-1784792467976", "name": "독자 이삭의 모리아산 번제드림", "desc": "하나님이 아브라함의 믿음을 시험하고자 백세에 얻은 외아들 이삭을 바치라 하실 때, 칼을 들어 드리려 하자 야훼 이레로 수양을 준비하신 사건.", "refs": ["창세기 22:10", "창세기 22:13"], "relatedLocations": ["loc-moriah"], "relatedPeople": ["abraham", "isaac"], "x": 16625, "y": 3641, "engName": "Reader Isaac’s Burnt Offering on Mount Moriah", "engDesc": "When God asked Abraham to sacrifice his only son Isaac, whom he had at the age of 100, to test his faith, when he was about to raise his sword to offer him up, Yahweh prepared a ram for him."}, {"id": "ev-1784792508036", "name": "바벨탑 건설과 언어의 혼잡", "desc": "인류가 하늘에 닿는 탑을 쌓아 자기 이름을 내고 흩어짐을 면하려 하자, 하나님이 언어를 혼잡하게 하사 온 지면에 흩으신 심판.", "refs": ["창세기 11:4", "창세기 11:9"], "relatedLocations": ["loc-shinar"], "relatedPeople": [], "x": 16562, "y": 2591, "engName": "Construction of the Tower of Babel and language confusion", "engDesc": "When mankind tried to make a name for themselves and avoid being scattered by building a tower that reached the sky, God confused their language and scattered them all over the earth."}, {"id": "ev-1784792646273", "name": "아브라함의 갈대아 우르 와 하란 소명", "desc": "본토 친척 아비 집을 떠나 보여줄 땅으로 가라는 하나님의 명령에 순종하여 75세에 아브라함이 믿음의 여정을 시작한 사건.", "refs": ["창세기 12:1", "창세기 12:4"], "relatedLocations": ["loc-1785964008527-61"], "relatedPeople": ["terah", "sarah", "abraham"], "x": 16499, "y": 3407, "engName": "Abraham's Calling to Ur and Haran of Chaldea", "engDesc": "An incident in which Abraham began his journey of faith at the age of 75 by obeying God's command to leave his native country, his relatives, and his father's house and go to the land he would show him."}, {"id": "ev-1785925947543", "name": "르호보암 VS 여로보암 항상 전쟁", "desc": "분열 직후 두 나라는 계속해서 전쟁 상태였다", "refs": ["왕상 14:30; 15:6"], "relatedLocations": [], "relatedPeople": ["rehoboam", "jeroboam1"], "x": 15559, "y": 6276, "engName": "Rehoboam VS Jeroboam always war", "engDesc": "Immediately after the split, the two countries continued to be at war."}, {"id": "ev-1785926110192", "name": "아비야 VS 여로보암 전쟁", "desc": "", "refs": ["왕상 15:7"], "relatedLocations": [], "relatedPeople": ["abijah", "jeroboam1"], "x": 15627, "y": 6348, "engName": "Abijah VS Jeroboam War"}, {"id": "ev-1785926290636", "name": "바아사 VS 아사 전쟁", "desc": "북왕국 바아사가 예루살렘을 압박하기 위해 라마를 건축하자, 남유다 아사가 아람(시리아) 왕 벤하닷에게 뇌물을 보내 북이스라엘의 배후를 치게 만들어 위기를 극복", "refs": ["왕상 15:16-22", "대하 16:1-6"], "relatedLocations": [], "relatedPeople": ["baasha", "asa"], "x": 15578, "y": 6582, "engName": "Baasha VS Asa War", "engDesc": "When Baasha of the northern kingdom built Ramah to put pressure on Jerusalem, Asa of the southern kingdom overcame the crisis by sending a bribe to Benhadad, king of Syria (Syria), to attack the rear of northern Israel."}, {"id": "ev-1785926544693", "name": "전략결혼과 동맹", "desc": "여호사밧의 아들 여호람과 아합의 딸 아달랴가 결혼하며 동맹을 맺었습니다. 이후 아람과의 길르앗 라못 전투에 연합군으로 참전", "refs": [], "relatedLocations": [], "relatedPeople": ["ahaziah_ahab", "ahab", "jehoram_ahab", "jehoshaphat"], "x": 15609, "y": 7038, "engName": "Strategic marriage and alliance", "engDesc": "Jehoram, the son of Jehoshaphat, and Athaliah, the daughter of Ahab, married and formed an alliance. Afterwards, he participated as an allied force in the Battle of Ramoth-Gilead against Aram."}, {"id": "ev-1785926941132", "name": "아하시야와 요람 동맹", "desc": "남유다의 아하시야가 아람과의 전쟁에서 부상을 입은 북이스라엘의 요람을 문병하러 갔다가, 북이스라엘에서 일어난 예후의 반란 과정에서 함께 죽임을 당함", "refs": ["(왕하 8:28-29", "9:27-28)"], "relatedLocations": [], "relatedPeople": ["ahaziah", "jehoram_ahab"], "x": 15810, "y": 7318, "engName": "Ahaziah and the Cradle Alliance", "engDesc": "Ahaziah of southern Judah went to visit Joram in northern Israel, who was injured in the war with Aram, and was killed along with Jehu during his rebellion in northern Israel."}, {"id": "ev-1785927235493", "name": "요아스 VS 아마샤 전쟁", "desc": "예후의 혁명 이후 동맹이 깨지면서 남북 간의 자존심 대결과 충돌.\n에돔을 무찌른 남유다 아마샤가 북이스라엘 요아스에게 전쟁을 도발했으나 대패. 요아스는 예루살렘 성벽을 헐고 성전 보물을 약탈", "refs": ["왕하 14:8-14", "대하 25:17-24"], "relatedLocations": [], "relatedPeople": ["amaziah", "jehoash_jehoahaz"], "x": 15848, "y": 7814, "engName": "Joash VS Amaziah War", "engDesc": "After Jehu's revolution, the alliance broke down, leading to a show of pride and conflict between the North and South.\nAmaziah of southern Judah, who defeated Edom, provoked war against Joash of northern Israel, but was defeated. Joash demolished the walls of Jerusalem and plundered the temple treasures."}, {"id": "ev-1786029213751", "name": "느헤미야의 예루살렘 성벽 성곽 중건 완공", "desc": "예루살렘 성벽이 허물어지고 성문이 소화되었다는 소식을 듣고 눈물로 기도한 술관원 느헤미야가, 총독으로 부임해 대적들의 방해 속에 한 손엔 병기를 들고 52일 만에 성벽을 완성한 중건.", "refs": ["느헤미야 4:17", "느헤미야 6:15"], "relatedLocations": ["loc-jerusalem_walls"], "relatedPeople": ["zerubbabel"], "x": 22079, "y": 7696, "engName": "Nehemiah's Rebuilding and Completion of the Jerusalem Walls", "engDesc": "Nehemiah, the cupbearer who wept and prayed upon hearing that the walls of Jerusalem were broken and its gates burned, returned as governor and successfully completed the reconstruction of the walls in 52 days under constant threat, with workers holding weapons in one hand."}, {"id": "ev-1786031894789", "name": "홍해 바다의 갈라짐과 애굽 군대 몰살", "desc": "진퇴양난의 홍해 앞에서 모세가 지팡이로 바다를 갈라 밤새 마른 땅으로 이스라엘 백성을 건너게 하시고, 뒤쫓던 애굽 마병들을 수장시키신 해방의 기적.", "refs": ["출애굽기 14:21", "출애굽기 14:28"], "relatedLocations": ["loc-red_sea"], "relatedPeople": ["moses", "aaron"], "x": 10404, "y": 4483, "engName": "Parting of the Red Sea and Annihilation of the Egyptian Army", "engDesc": "The miracle of liberation where Moses parted the Red Sea with his staff, allowing the Israelites to cross on dry ground, and drowned the pursuing Egyptian horsemen and chariots in the sea."}, {"id": "ev-1786032977555", "name": "야곱 온 가족의 고센 땅 애굽 이주", "desc": "전례 없는 기근 속에서 요셉의 통치권 하에 있던 애굽으로 70명의 야곱 권속이 수레를 타고 정착하여 거대한 민족의 기틀을 마련한 사건.", "refs": ["창세기 46:27", "창세기 47:1"], "relatedLocations": ["loc-1786036569158-55"], "relatedPeople": ["carmi_reuben", "gad", "gera_benjamin", "gershon_levi", "kohath", "guni", "naaman_benjamin", "naphtali", "dan", "tola_issachar", "dinah", "levi", "rosh", "reuben", "malchiel_beriah", "muppim", "manasseh", "merari_levi", "pallu_reuben", "becher", "benjamin", "perez", "bela", "puah_issachar", "beriah_asher", "shaul_simeon", "serah_asher", "zerah", "sered_zebulun", "shelah-1", "shuni_gad", "zebulun", "zohar_simeon", "shimron_issachar", "simeon", "ziphion_gad", "shillem", "areli_gad", "arodi_gad", "ard", "asher", "ashbel", "jacob", "jachin_simeon", "jamin_simeon", "jahzeel", "jahleel_zebulun", "eri_gad", "ephraim", "ezbon_gad", "ehi", "elon_zebulun", "jemuel_simeon", "jezer", "ohad_simeon", "joseph", "jashub_issachar", "judah", "ishvah_asher", "ishvi_asher", "imnah_asher", "issachar", "hanoch_reuben", "hamul", "haggi_gad", "heber_beriah", "hezron_reuben", "hezron", "hushim_1", "huppim"], "x": 16580, "y": 3849, "engName": "Jacob's entire family migrates from Egypt to the land of Goshen", "engDesc": "An incident in which 70 members of Jacob's family settled by wagon in Egypt, under Joseph's rule, during an unprecedented famine, laying the foundation for a great nation."}, {"id": "ev-1786037573263", "name": "선악과 사건과 인류의 타락", "desc": "뱀의 유혹으로 하와와 아담이 선악과를 먹고 하나님의 명령을 어겨 에덴동산에서 추방당하고 인류에 죄가 들어온 사건.", "refs": ["창세기 3:6", "창세기 3:23"], "relatedLocations": ["loc-eden"], "relatedPeople": ["adam", "eve"], "x": 16025, "y": 165, "engName": "The Forbidden Fruit and the Fall of Mankind", "engDesc": "The incident where Adam and Eve, tempted by the serpent, ate the forbidden fruit and disobeyed God's command, resulting in their expulsion from the Garden of Eden and the entry of sin into the world."}]);

  // Seed Locations
  safeSeedArray('bible_tree_locations', [{"id": "loc-1784790667582", "name": "홍해", "desc": "뒤쫓아오는 애굽 군대 앞에서 모세가 지팡이를 내밀어 밤새 동풍으로 바다를 가르고 마른 땅처럼 건넌 기적의 바다.", "refs": ["출애굽기 14:21", "출애굽기 14:22"], "relatedEvents": ["ev-crossing_red_sea"], "relatedPeople": ["moses", "aaron"], "x": 10401, "y": 4554, "engName": "red sea", "engDesc": "In front of the pursuing Egyptian army, Moses held out his staff and parted the sea with an east wind all night long, crossing it like dry land."}, {"id": "loc-1784790981421", "name": "에덴동산", "desc": "인류 최초의 거처이자 생명나무와 선악을 알게 하는 나무가 있던 낙원.", "refs": ["창세기 2:8", "창세기 2:15"], "relatedEvents": ["ev-eden_sin"], "relatedPeople": ["adam", "eve"], "x": 16128, "y": 75, "engName": "Garden of Eden", "engDesc": "Paradise, the first home of mankind and the location of the tree of life and the tree of knowledge of good and evil."}, {"id": "loc-1784792563461", "name": "시날 평지", "desc": "노아의 후손들이 모여 바벨탑을 쌓으며 하나님께 대적했던 평원.", "refs": ["창세기 11:2"], "relatedEvents": ["ev-babel_tower"], "relatedPeople": ["noah"], "x": 16558, "y": 2661, "engName": "Plain of Shinar", "engDesc": "A plain where Noah's descendants gathered to build the Tower of Babel and oppose God."}, {"id": "loc-1784792669341", "name": "하란", "desc": "아브라함의 아버지 데라가 머물다 죽은 곳이자 아브라함이 소명을 받고 떠난 땅.", "refs": ["창세기 11:31", "창세기 12:4"], "relatedEvents": ["ev-abraham_haran"], "relatedPeople": ["terah", "abraham", "sarah"], "x": 16664, "y": 3406, "engName": "Haran", "engDesc": "This is the place where Abraham's father Terah stayed and died, and the land where Abraham left after receiving his calling."}, {"id": "loc-1784793488527", "name": "모리아산", "desc": "아브라함이 독자 이삭을 번제로 바치려 했던 산이자 훗날 솔로몬 성전이 건축된 장소.", "refs": ["창세기 22:2"], "relatedEvents": ["ev-isaac_offering"], "relatedPeople": ["abraham", "isaac"], "x": 16446, "y": 3680, "engName": "Mount Moriah", "engDesc": "This is the mountain where Abraham attempted to sacrifice his only son Isaac as a burnt offering, and the place where Solomon's temple was later built."}, {"id": "loc-1786029363695", "name": "예루살렘 성벽", "desc": "느헤미야 총독의 헌신과 이스라엘 백성들의 일치단결로 방해자들의 위협 속에서도 52일 만에 중건한 예루살렘 성벽 성곽.", "refs": ["느헤미야 2:17", "느헤미야 6:15"], "relatedEvents": ["ev-walls_rebuild"], "relatedPeople": ["zerubbabel"], "x": 22077, "y": 7772, "engName": "Jerusalem Walls", "engDesc": "The walls and ramparts of Jerusalem rebuilt in 52 days under governor Nehemiah's leadership and the unified dedication of the Israelites despite threats from adversaries."}, {"id": "loc-1786033012492", "name": "애굽 고센 땅", "desc": "가나안 기근 때 요셉의 초청으로 입성한 야곱의 가족들이 정착하여 번성한 비옥한 목초지.", "refs": ["창세기 47:6"], "relatedEvents": ["ev-goshen_migration"], "relatedPeople": ["jacob", "joseph"], "x": 16580, "y": 3940, "engName": "land of Goshen, Egypt", "engDesc": "A fertile pasture where Jacob's family, who entered the country at the invitation of Joseph during the Canaan famine, settled and prospered."}]);

  // Seed Custom Polygons
  safeSeedArray('bible_tree_custom_polygons', [{"id": "poly-cain", "label": "가인 자손 계열", "color": "#ef4444", "fillOpacity": 0.03, "points": [{"x": 15080, "y": 240}, {"x": 15924.48, "y": 240}, {"x": 15924.48, "y": 1440}, {"x": 15080, "y": 1440}], "label_en": "Cain descendants line", "labelOffsetX": 32.53226240007701, "labelOffsetY": -14.14446191307696}, {"id": "poly-japheth", "label": "야벳 자손 (유럽/북방계 민족)", "color": "#22c55e", "fillOpacity": 0.03, "points": [{"x": 14074.48, "y": 1860}, {"x": 15424.48, "y": 1860}, {"x": 15424.48, "y": 2340}, {"x": 14074.48, "y": 2340}], "label_en": "Descendants of Japheth (European/Northern people)", "labelOffsetX": 32.532262400077016, "labelOffsetY": -9.901123339153873}, {"id": "poly-ham", "label": "함 자손 (가나안/아프리카계 민족)", "color": "#f97316", "fillOpacity": 0.03, "points": [{"x": 15454.48, "y": 1860}, {"x": 16174.48, "y": 1860}, {"x": 16174.48, "y": 2340}, {"x": 15454.48, "y": 2340}], "label_en": "Descendants of Ham (Canaanite/African people)", "labelOffsetX": 23.46201806727417, "labelOffsetY": -11.040949678717256}, {"id": "poly-joktan", "label": "욕단 자손 (아라비아 부족 연합)", "color": "#3b82f6", "fillOpacity": 0.03, "points": [{"x": 14184.48, "y": 2580}, {"x": 16184.48, "y": 2580}, {"x": 16184.48, "y": 2880}, {"x": 14184.48, "y": 2880}], "label_en": "Descendants of Joktan (Arabian tribal confederation)", "labelOffsetX": 1549.1219951299995, "labelOffsetY": -9.486677147846176}, {"id": "poly-keturah", "label": "그두라 자손 (미디안 등 아라비아 부족)", "color": "#ec4899", "fillOpacity": 0.03, "points": [{"x": 14524.48, "y": 2990}, {"x": 15814.48, "y": 2990}, {"x": 15814.48, "y": 3500}, {"x": 14524.48, "y": 3500}], "label_en": "Descendants of Keturah (Arabian tribes such as Midian)", "labelOffsetX": 839.5820265735381, "labelOffsetY": -8.657784765230783}, {"id": "poly-ishmael", "label": "이스마엘 12방백 자손 (아랍 민족)", "color": "#a855f7", "fillOpacity": 0.03, "points": [{"x": 14014.48, "y": 3580}, {"x": 16154.48, "y": 3580}, {"x": 16154.48, "y": 3800}, {"x": 14014.48, "y": 3800}], "label_en": "Descendants of the 12 princes of Ishmael (Arab people)", "labelOffsetX": 1693.9508875126148, "labelOffsetY": -10.901123339153873}, {"id": "poly-mary", "label": "마리아 계보 (누가복음 3장 혈통)", "color": "#06b6d4", "fillOpacity": 0.03, "points": [{"x": 14741.24, "y": 6000}, {"x": 14951.24, "y": 6000}, {"x": 14941.24, "y": 11310}, {"x": 14741.24, "y": 11310}], "label_en": "Mary's Genealogy (Luke 3 Lineage)", "labelOffsetX": -28.288923826153923, "labelOffsetY": -4.243338573923088}, {"id": "poly-custom-1785266075158", "label": "잇사갈 지파(창 46:13. 민 26:23,24, 대상 7:1-4)", "color": "#3b82f6", "fillOpacity": 0.03, "points": [{"x": 20631.239999999998, "y": 4020}, {"x": 21750, "y": 4020}, {"x": 21751.239999999998, "y": 5000}, {"x": 20636.931574215196, "y": 4998.0145519272855}], "label_en": "Tribe of Issachar (Genesis 46:13; Numbers 26:23,24; 1 Chronicles 7:1-4)", "labelOffsetX": 12.730015721769265, "labelOffsetY": -12.730015721769265}, {"id": "poly-custom-1785292170590", "label": "에서의 족보(창 11:27-32, 창 36:1-5, 창 36:9-30, 창 36:40-43, 대상 1:34-32, 대상 1:521-54)", "color": "#06b6d4", "fillOpacity": 0.03, "points": [{"x": 11625.109375, "y": 3454}, {"x": 13926.11719767249, "y": 3454}, {"x": 13926.11719767249, "y": 3949.1220334042905}, {"x": 11626.109371762588, "y": 3949.122033404291}], "labelOffsetX": 36.5855538086923, "labelOffsetY": -11.730015721769265, "label_en": "Esau's genealogy (Genesis 11:27-32, Genesis 36:1-5, Genesis 36:9-30, Genesis 36:40-43, 1 Chronicles 1:34-32, 1 Chronicles 1:521-54)"}, {"id": "poly-custom-1785292260091", "label": "호리족속의 족장들(창 36:20-30)", "color": "#ef4444", "fillOpacity": 0.03, "points": [{"x": 7561.109375, "y": 3629}, {"x": 11266.112748817628, "y": 3628.999999999999}, {"x": 11266.112748817628, "y": 3957.0015141180716}, {"x": 7562.107216810187, "y": 3957.001514118072}], "labelOffsetX": -307.97335429569233, "labelOffsetY": -11.07223095653848, "label_en": "Horite chieftains (Genesis 36:20-30)"}, {"id": "poly-custom-1785470013891", "label": "르우벤 지파(창 46:9, 민 26:5-11, 대상 5:3-9)", "color": "#f97316", "fillOpacity": 0.03, "points": [{"x": 6320, "y": 4020}, {"x": 7173.111507193738, "y": 4020}, {"x": 7173.111507193738, "y": 6362.926888556567}, {"x": 6320, "y": 6360}], "label_en": "Tribe of Reuben (Genesis 46:9, Numbers 26:5-11, 1 Chronicles 5:3-9)"}, {"id": "poly-custom-1785470264092", "label": "시므온 지파(창 46:10, 민 26:12, 13, 대상 4:24-38)", "color": "#3b82f6", "fillOpacity": 0.03, "points": [{"x": 7191.109375, "y": 4020}, {"x": 8233.433700725924, "y": 4020}, {"x": 8233.433700725924, "y": 4326.209471364206}, {"x